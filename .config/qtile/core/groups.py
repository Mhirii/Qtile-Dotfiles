...
groups = [
    ...
    Group("5", label=" 󱍿", init=True),
    Group("6", label="󱍿", init=True),
    Group("7", label="󱍿", init=True),
    Group("8", label="󱍿", init=True),
    ...
    Group("o", label="", init=True, matches=mail_clients, spawn=apps.MAIL),
